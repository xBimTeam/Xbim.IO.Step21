...
{
    /// <summary>
    /// Helper class to produce IFC compliant guids.
    /// </summary>
    public static class GuidFunctions
    {
        ...
        /// </summary>
        public static string ConvertToBase64(System.Guid guid)
        {
        ...
        private static string To64String(uint num, int nDigits)
        {
            ...
            {
                result[nDigits - iDigit - 1] = _conversionTable[(int)(act % 64)];
                act /= 64;
            }
            return new string(result);
        }

        private const string _conversionTable =
          //          1         2         3         4         5         6   
